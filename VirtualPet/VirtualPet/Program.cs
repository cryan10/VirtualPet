...
namespace VirtualPet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("Now that you know what your dog looks like, it's time to bond! Ask your dog yes or no questions. When you've asked enough questions, type \"quit\": ");
            string question = Console.ReadLine();
            bool questionAsked = true;

            while (questionAsked == true)
            {
                ...
                {
                    dog.GettingToKnowYou(question);
                    Console.WriteLine("Ask another question! Type \"quit\" when you're done asking questions");
